...
<body style="font-family: Open Sans;">
  ...
  <div id="about" class="container-fluid text-light p-5" style="background-color: #58a7e0;">
    <div class="row">
  ...
  <div class="container-fluid text-light p-5" style="background-color: #2b2a2a;">
    <div class="row">
  ...
  <div class="container-fluid text-light p-5" style="background-color: #bf2837;">
    <div class="row">
  ...
  <div class="container-fluid text-dark p-5 bg-white" id="contacto">
    <div class="row">
      <div class="col-12 col-md-6 mx-auto">
        ...
        <label><i class="fab fa-whatsapp"></i>&nbsp;<b>Whatsapp: </b>81 8083 0218</label><br><br>
      ...
      <div class="col-12 col-md-6">
        <form>
          <div class="form-group">
            ...
            <center><h5>¿Tienes preguntas?</h5></center><hr>
            <label>Nombre:</label>
            <input type="text" placeholder="Juan Pérez Martínez" class="form-control" required>
            <br><label>Correo electrónico:</label>
            <input type="email" placeholder="alguien@ejemplo.com" class="form-control" required>
            <br><label>Escribe tu mensaje:</label>
            <textarea class="form-control" rows="5" required></textarea>
            <br><center><button type="submit" class="btn btn-outline-dark">Enviar</button></center>
          </div>
        </form>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <div class="d-block d-sm-none"><br></div>
        <h5>Visítanos</h5><hr><br>
        <div class="gmap_canvas"><iframe width="100%;" height="350px;" id="gmap_canvas" src="https://maps.google.com/maps?q=paseo%20de%20los%20leones%20123&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div><style>.mapouter{position:relative;text-align:right;height:200px;width:350px;}.gmap_canvas {overflow:hidden;background:none}</style>
      </div>
    </div>
  </div>
  <!-- /.container -->
